...
func (l *DocumentLoader) generateLibraryDoc(pathStr string) (*document.Document, error) {
	...
	switch u.Path {
	case "/library":
		return l.libraryLanguagesPage()
	case "/library/categories":
		return l.libraryCategoriesPage(u)
	case "/library/entries":
		return l.libraryEntriesPage(u)
...
func (l *DocumentLoader) libraryLanguagesPage() (*document.Document, error) {
...
func (l *DocumentLoader) libraryCategoriesPage(u *url.URL) (*document.Document, error) {
...
func (l *DocumentLoader) libraryEntriesPage(u *url.URL) (*document.Document, error) {
	lang := u.Query().Get("lang")
